...
export const GLOBAL_TICKER_DIRECTORY: TickerInfo[] = [
  // Mega-Cap Tech & AI
  { symbol: "NVDA", name: "NVIDIA", sector: "Semiconductors & AI Hardware", basePrice: 255.59, baseMcap: 6270, peRatio: 54.2 },
  { symbol: "GOOGL", name: "Alphabet (Google)", sector: "Internet Services & AI", basePrice: 453.79, baseMcap: 5491, peRatio: 26.8 },
  { symbol: "AAPL", name: "Apple", sector: "Consumer Electronics", basePrice: 348.21, baseMcap: 5150, peRatio: 33.4 },
  { symbol: "MSFT", name: "Microsoft", sector: "Cloud & Enterprise Software", basePrice: 571.84, baseMcap: 4251, peRatio: 36.1 },
  { symbol: "AMZN", name: "Amazon", sector: "E-Commerce & Cloud", basePrice: 322.75, baseMcap: 3456, peRatio: 41.5 },
  { symbol: "META", name: "Meta Platforms", sector: "Social Media & AI", basePrice: 992.47, baseMcap: 2507, peRatio: 29.2 },
  { symbol: "TSM", name: "TSMC", sector: "Semiconductor Foundry", basePrice: 449.99, baseMcap: 2333, peRatio: 31.0 },
  { symbol: "TSLA", name: "Tesla", sector: "Electric Vehicles & Clean Energy", basePrice: 585.92, baseMcap: 2198, peRatio: 88.4 },
  { symbol: "AVGO", name: "Broadcom", sector: "Networking & Silicon", basePrice: 451.00, baseMcap: 2138, peRatio: 42.1 },
